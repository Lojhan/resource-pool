...
let __wasmFilePath = __nodePath.join(__dirname, 'resource_pool.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'resource_pool.wasm32-wasi.debug.wasm')
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    ...
    throw new Error(
      'Cannot find resource_pool.wasm32-wasi.wasm file, and @lojhan/resource-pool-wasm32-wasi package is not installed.',
    )
  }
}
